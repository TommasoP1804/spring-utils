...
[![Spring Boot](https://img.shields.io/badge/Spring_Boot-4.0.0-green.svg)](https://spring.io/projects/spring-boot)
...
dependencies {
    implementation("dev.tommasop1804:spring-utils:3.0.0")
}
```
