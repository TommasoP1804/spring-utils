...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260404T105056Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.4.0")
    api("dev.tommasop1804:kotlin-utils:3.4.0")
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "3.3.3")
