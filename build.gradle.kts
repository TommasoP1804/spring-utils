...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260314T153043Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.0.2")
    api("dev.tommasop1804:kotlin-utils:3.0.2")
}
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "2.3.3")
