...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260323T115448Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.1.1")
    api("dev.tommasop1804:kotlin-utils:3.1.1")
}
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "2.5.0")
