...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260326T125321Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.1.3")
    api("dev.tommasop1804:kotlin-utils:3.1.3")
}
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "3.0.4")
