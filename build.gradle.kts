...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260325T181911Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.1.2")
    api("dev.tommasop1804:kotlin-utils:3.1.2")
}
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "3.0.0-EAP1")
