...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260331T120157Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.3.3")
    api("dev.tommasop1804:kotlin-utils:3.3.3")
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "3.2.5-BETA1")
