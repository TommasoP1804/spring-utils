...
// Spring-Utils
// Tommaso Pastorelli
// Last update: Tommaso Pastorelli | 20260401T115724Z
...
dependencies {
    ...
    aspect("dev.tommasop1804:kotlin-utils:3.3.4")
    api("dev.tommasop1804:kotlin-utils:3.3.4")
...
mavenPublishing {
    coordinates("dev.tommasop1804", "spring-utils", "3.3.2")
