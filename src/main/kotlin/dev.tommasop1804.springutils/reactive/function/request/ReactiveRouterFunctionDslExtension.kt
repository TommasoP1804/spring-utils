 ...
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(f: Transformer<Request, Mono<out Response>>) = methods(Put, Post)(f)
/**
 ...
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(pattern: String, f: Transformer<Request, Mono<out Response>>) =
 ...
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(predicate: RequestPredicate, f: Transformer<Request, Mono<out Response>>) =
 ...
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(pattern: String, predicate: RequestPredicate, f: Transformer<Request, Mono<out Response>>) =
