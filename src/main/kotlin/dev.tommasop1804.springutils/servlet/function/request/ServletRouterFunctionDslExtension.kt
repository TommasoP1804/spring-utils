...
@file:JvmName("ServletRouterFunctionDslExtensionsKt")
...
import dev.tommasop1804.springutils.servlet.function.request.RequestPredicates.method
import dev.tommasop1804.springutils.servlet.function.request.RequestPredicates.methods
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrPOST(f: Transformer<Request, Response>) = methods(Get, Post)(f)
/**
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrPOST(pattern: String, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrPOST(predicate: RequestPredicate, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrPOST(pattern: String, predicate: RequestPredicate, f: Transformer<Request, Response>) =
...
/**
 * Defines a route that accepts HTTP POST or PUT requests, allowing a request transformer function
 * to handle the incoming requests.
 *
 * @param f A transformer function that takes a request of type `Request` and produces a response
 *          wrapped in a `Mono` of type `Response`. This function defines the logic to process
 *          the incoming POST or PUT requests.
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(f: Transformer<Request, Response>) = methods(Put, Post)(f)
/**
 * Adds a route to the router that matches HTTP POST or PUT methods for the specified path pattern
 * and applies the given handler function to process the request.
 *
 * @param pattern The path pattern to match against the incoming request. This determines the
 * routes where the handler function will be applied.
 * @param f The handler function that transforms a `Request` into a reactive `Mono` of a `Response`.
 * This function contains the logic to handle requests matching the specified pattern.
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(pattern: String, f: Transformer<Request, Response>) =
    (methods(Put, Post) and path(pattern))(f)
/**
 * A utility function that combines HTTP POST and PUT method predicates with an additional request predicate
 * and applies a given transformation function to handle the matched requests.
 *
 * This function merges the functionality of the HTTP POST and PUT methods, allowing you to define a single handler
 * for both request types, with an optional filter applied through the provided request predicate.
 *
 * @param predicate A `RequestPredicate` that serves as an additional filter for matching the requests.
 * It allows fine-grained control over the requests that should be handled by this route.
 * @param f A transformation function that processes a `Request` and returns a `Mono<Response>`.
 * This function contains the logic for handling the matched requests and producing the appropriate response.
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(predicate: RequestPredicate, f: Transformer<Request, Response>) =
    (methods(Put, Post) and predicate)(f)
/**
 * Registers a handler function that matches requests with HTTP methods POST or PUT,
 * a specified URL pattern, and an additional custom predicate.
 *
 * @param pattern The URL pattern to match for the request.
 * @param predicate An additional `RequestPredicate` to further filter requests.
 * @param f A handler function that transforms a `Request` into a `Mono` of `Response`.
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(pattern: String, predicate: RequestPredicate, f: Transformer<Request, Response>) =
    (methods(Put, Post) and path(pattern) and predicate)(f)
/**
 * Adds a route that matches requests with either the HTTP POST or PUT method and the specified path pattern.
 *
 * @param pattern The path pattern to match requests against. This can include placeholders for dynamic segments.
 * @since 5.1.0
 */
fun RouterFunctionDsl.POSTOrPUT(pattern: String) = (methods(Put, Post) and path(pattern))
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrQUERY(f: Transformer<Request, Response>) = methods(Get, Query)(f)
/**
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrQUERY(pattern: String, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrQUERY(predicate: RequestPredicate, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.GETOrQUERY(pattern: String, predicate: RequestPredicate, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.QUERY(f: Transformer<Request, Response>) = method(Query)(f)
/**
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.QUERY(pattern: String, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.QUERY(predicate: RequestPredicate, f: Transformer<Request, Response>) =
 ...
 * @since 4.5.0
 */
fun RouterFunctionDsl.QUERY(pattern: String, predicate: RequestPredicate, f: Transformer<Request, Response>) =
