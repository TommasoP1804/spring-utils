...
annotation class AcceptCharset

@Component
class AcceptCharsetArgumentResolver : HandlerMethodArgumentResolver {

    override fun supportsParameter(parameter: MethodParameter) =
        parameter.hasParameterAnnotation(AcceptCharset::class.java)
