...
annotation class AcceptEncoding

@Component
class AcceptEncodingArgumentResolver : HandlerMethodArgumentResolver {

    override fun supportsParameter(parameter: MethodParameter) =
        parameter.hasParameterAnnotation(AcceptEncoding::class.java)
...
class AcceptEncodingArgumentResolverAutoConfiguration {
    @Configuration
